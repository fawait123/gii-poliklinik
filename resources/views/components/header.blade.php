...
<header x-data="dashboardStore"
    class="sticky bg-primary-25 top-0 z-99999 flex w-full border-gray-200 dark:border-gray-800 dark:bg-gray-900">
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <!-- Application nav menu button -->
            <x-breadcrumb :pageName="$pageName" :items="$breadcrumbItems" />
        </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }">
                <a class="flex items-center gap-3" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="hidden text-right lg:block">
                        <span class="block text-sm font-medium text-gray-700 dark:text-gray-300" x-text="user ? user.name : 'Guest'"></span>
                        <span class="block text-xs text-gray-500 dark:text-gray-400" x-text="user ? user.email : ''"></span>
                    </span>

                    <span class="h-12 w-12 rounded-full overflow-hidden bg-gray-200" x-show="user">
                        <img src="{{ asset('assets/images/user.png') }}" alt="User" class="h-full w-full object-cover" />
                    </span>

                    <svg class="hidden fill-current sm:block" width="12" height="8" viewBox="0 0 12 8"
                        fill="none" xmlns="http://www.w3.org/2000/svg" x-show="user">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div x-show="dropdownOpen" @click.outside="dropdownOpen = false"
                    class="absolute right-0 mt-4 flex w-62.5 flex-col rounded-lg border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
